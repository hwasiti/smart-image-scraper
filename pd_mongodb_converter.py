...
df1_100 = pd.read_json(open('flickr_monkey_wild_df_100.json', "r", encoding="utf-8-sig"))
df2_100 = pd.read_json(open('flickr_monkey_cage_df_100.json', "r", encoding="utf-8-sig"))

df1 = pd.read_json(open('flickr_monkey_wild_df.json', "r", encoding="utf-8-sig"))
df2 = pd.read_json(open('flickr_monkey_cage_df.json', "r", encoding="utf-8-sig"))
