...
def get_links(search_query, n=10, download=False):
    t = time.time()
    ...
    data = list(zip(search_terms, date_of_downloads, time_of_downloads, filenames, urls))
...
if __name__ == '__main__':
    ...
    pd_data = get_links(search_query=args.search,  # search term
